...
@PreTrainedConfig.register_subclass("pi0_drift")
@dataclass
class PI0DriftConfig(PreTrainedConfig):
    ...
    # PI0-Drift owns its recipe rather than importing a shared Drift config.
    ...
    def __post_init__(self):
        ...
        if self.rtc_config is not None:
            raise ValueError("PI0-Drift is one-step and incompatible with RTC's iterative integrator.")
