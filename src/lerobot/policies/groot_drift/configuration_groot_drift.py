...
@PreTrainedConfig.register_subclass("groot_drift")
@dataclass
class GrootDriftConfig(GrootConfig):
    """GR00T N1.7 with an independent one-step Drifting action head objective."""
